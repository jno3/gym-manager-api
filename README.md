...
>>Logout.
>>
>>This is how a client logs out. If there's a token in the Authorization Header, the token will be deemed invalid and won't work anymore, forcing the user to log-in again. Works for both gyms and clients.
>>```JSON
>>request endpoint:
